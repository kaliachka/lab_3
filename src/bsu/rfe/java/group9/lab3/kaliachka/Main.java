package bsu.rfe.java.group9.lab3.kaliachka;
...
public class Main extends JFrame
{
    ...
    private Main(Double[] coefficients)
    {
        ...
        // Создать новое "действие" по открытию "О программе"
        Action aboutAction = new AbstractAction("О программе")
        {
            public void actionPerformed(ActionEvent event)
            {
                JOptionPane.showMessageDialog(Main.this, "9 группа, Колячко Ксения Юрьевна", "О программе", JOptionPane.INFORMATION_MESSAGE);
            }
        };
        // Добавить соответствующий пункт подменю в меню "Сп    равка"
